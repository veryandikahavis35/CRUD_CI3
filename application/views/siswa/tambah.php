...
<body>
    ...
    <div class="container">
        ...
        <input type="text" name="Username" class="rounded-pill form-control border-info"  required><br>
        <label for=""><h6>Email</h6></label><br>
        <input type="text" name="Account" class="rounded-pill form-control border-info" required><br>
        <label for=""><h6>Password</h6></label><br>
        <input type="text" name="Password" class="rounded-pill form-control border-info" required><br>
